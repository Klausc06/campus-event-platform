...
with app.app_context():
    ...
    if User.query.count() == 0:
        ...
        events = [
            Event(title="新学期迎新晚会", title_en="Welcome Party for New Students",
                  description="欢迎新同学加入校园大家庭，现场音乐、美食与互动游戏",
                  description_en="Welcome new students with live music, food and interactive games",
                  location="大礼堂", location_en="Main Auditorium",
                  start_time=now + timedelta(days=7), end_time=now + timedelta(days=7, hours=3),
                  max_participants=200, checkin_code="WELCOME", creator_id=admin.id, category="文艺"),
            Event(title="Python编程工作坊", title_en="Python Programming Workshop",
                  description="从零开始学习Python编程，动手构建你的第一个应用",
                  description_en="Learn Python programming from scratch and build your first application",
                  location="计算机实验室A301", location_en="Computer Lab A301",
            ...
            Event(title="职业规划讲座", title_en="Career Planning Seminar",
                  description="企业HR分享求职经验与职场建议",
                  description_en="Corporate HR shares job hunting experience and career advice",
                  location="学术报告厅", location_en="Academic Lecture Hall",
